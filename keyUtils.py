...
def derSigToHexSig(s):
    s, junk = ecdsa.der.remove_sequence(codecs.decode(s, encoding='hex'))
...
def privateKeyToPublicKey(s):
    return bitcoin.privkey_to_pubkey(s)

# Input is hex string
def keyToAddr(s):
    return bitcoin.pubtoaddr(privateKeyToPublicKey(s))

def pubKeyToAddr(s):
    return bitcoin.pubtoaddr(s)
